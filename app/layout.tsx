...
export const metadata: Metadata = {
  ...
  description:
    "Deploy your first AI Video Agent today! Boost engagement and automate conversations.",
  keywords: [
    "AI Video Agent",
    "Virtual Agent",
    "AIVA",
  ...
  return (
    <html lang="en">
      ...
      `,
        ...
        {/* ================= Google Ads / gtag.js (NEW) ================= */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-387058456"
          strategy="afterInteractive"
        />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                "@type": "SearchAction",
                target:
                  "https://aiva.saleassist.ai/search?q={search_term_string}",
      ...
      <body
        className={`font-sans ${GeistSans.variable} ${GeistMono.variable} hero-gradient min-h-screen`}
      >
        {/* ========= GTM NOSCRIPT ========= */}
        <noscript>
          <iframe
